            ...
            <div class="container-fluid w-75">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="./assets/products/2.png" style="height: 120px;" alt="cartitem" class="img-fluid">
                            </div>
                            <div class="col-sm-8">
                                <h5 class="font-roboto font-size-20">Samsung Galaxy S10</h5>
                                <small>by Samsung</small>
                                ...
                                <div class="qty d-flex pt-2">
                                    ...
                                    <button class="btn font-roboto font-size-14 text-danger px-3 border-right">Delete</button>
                                    <button class="btn font-roboto font-size-14  text-danger ">Save for Later</button>
                                </div>
                                <!-- end of product quantity -->
